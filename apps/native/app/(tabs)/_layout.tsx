...
export default function TabLayout() {
  return (
    <Tabs screenOptions={{ headerShown: false, tabBarStyle: styles.tabBar, tabBarShowLabel: false }}>
      ...
      <Tabs.Screen name="calls" options={{ tabBarIcon: ({ focused }) => <TabIcon emoji="📞" label="Calls" focused={focused} /> }} />
      <Tabs.Screen name="connections" options={{ tabBarIcon: ({ focused }) => <TabIcon emoji="💜" label="Stats" focused={focused} /> }} />
...
const styles = StyleSheet.create({
  tabBar: { borderTopColor: "#f3f4f6", paddingTop: 8, height: 72 },
  tabItem: { alignItems: "center", gap: 2 },
  tabEmoji: { fontSize: 22 },
  tabLabel: { fontSize: 10, color: "#9ca3af", fontWeight: "500" },
  tabLabelActive: { color: "#d946ef" },
});
